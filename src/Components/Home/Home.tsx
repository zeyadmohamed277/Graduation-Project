      ...
      <div style={{ width: "100%" }}>
          ...
          <div style={{ container: "true" }}>
            ...
            >
              <Card  sx={{ maxWidth: 345, border: "1px solid grey" }}>
                <Link to={`/ReceipeDetails/53027`} style={{ textDecoration: "none" }}>
                <CardMedia
                  component="img"
                  height="194"
                  image="https://www.themealdb.com/images/media/meals/4er7mj1598733193.jpg"
                />
                <CardHeader sx={{color:"black"}} title="Koshari" subheader="Egyptian Dish" />
                <CardContent>
              ...
              <Card sx={{ maxWidth: 345, border: "1px solid grey" }}>
              <Link to={`/ReceipeDetails/52844`} style={{ textDecoration: "none" }}>
                <CardMedia
                  component="img"
                  height="194"
                  image="https://www.themealdb.com/images/media/meals/wtsvxx1511296896.jpg"
                />
                <CardHeader sx={{color:"black"}} title="Lasagne" subheader="Italian Dish" />
              ...
              <Card sx={{ maxWidth: 345, border: "1px solid grey" }}>
              <Link to={`/ReceipeDetails/52854`} style={{ textDecoration: "none" }}>
                <CardMedia
                  component="img"
                  height="194"
                  image="https://www.themealdb.com/images/media/meals/rwuyqx1511383174.jpg"
                />
                <CardHeader sx={{color:"black"}} title="Pancakes" subheader="American Dish" />
                <CardContent>
                  <Typography variant="body2" sx={{ color: "text.secondary" }}>
              ...
              <Card sx={{ maxWidth: 345, border: "1px solid grey" }}>
              <Link to={`/ReceipeDetails/53028`} style={{ textDecoration: "none" }}>
                <CardMedia
                  component="img"
                  height="194"
                  image="https://www.themealdb.com/images/media/meals/kcv6hj1598733479.jpg"
                />
                <CardHeader sx={{color:"black"}} title="Shawarma" subheader="Egyptian Dish" />
                <CardContent>
                  <Typography variant="body2" sx={{ color: "text.secondary" }}>
        ...
        >
          ...
          >
            ...
            >
              <Card
                sx={{ boxshadow: "1px -1px 5px 8px rgba(160,146,146,0.75)" }}
              >
                <CardContent className="pt-6">
                  ...
                  <p>
                    "The ingredient lists are so well organized, and I
                    appreciate that there are suggestions for substitutions. As
                    someone with dietary restrictions, this has been incredibly
                    helpful. The vegetarian lasagna was a hit!"
                  </p>
                </CardContent>
              </Card>
            </div>
